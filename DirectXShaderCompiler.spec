...
%define lib32dxcompiler %{mklib32name dxcompiler}
%define dev32dxcompiler %{mklib32name -d dxcompiler}
...
%if %{with compat32}
%package -n %{lib32dxcompiler}
Summary:  32-bit DirectX Shader Compiler library
Group:    Development/Graphics

%description -n %{lib32dxcompiler}
32-bit DirectX Shader Compiler standalone dynamic library

%package -n %{dev32dxcompiler}
Summary:  32-bit DirectX Shader Compiler library development files
Group:    Development/Graphics
Requires: %{lib32dxcompiler} = %{EVRD}
Requires: %{devdxcompiler} = %{EVRD}

%description -n %{dev32dxcompiler}
32-bit DirectX Shader Compiler standalone dynamic library
%endif
...
mv -v build32/lib*/libdxc* %{buildroot}%{_prefix}/lib/
%endif
...
%if %{with compat32}
%files -n %{lib32dxcompiler}
%{_prefix}/lib/libdxcompiler.so*

%files -n %{dev32dxcompiler}
%{_prefix}/lib/*.a
%endif
